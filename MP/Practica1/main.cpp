...
int main() {
    ...
    int opcion;
    cout << "Elige la parte que quieres probar: \n 1.-Parte 1 \n 2.-Parte 2" << endl;
    ...
    switch (opcion) {
        ...
        case 1: {
            ...
            const Fecha f2=f1;//indica que metodo se esta ejecutando aqui //Constructor de copia
        ...
        case 2: {
            ...
            //cout << setprecision(2) << fixed;//a partir de aqui float se muestracon 2 decimales   //TODO: ver que le pasa a esta linea
