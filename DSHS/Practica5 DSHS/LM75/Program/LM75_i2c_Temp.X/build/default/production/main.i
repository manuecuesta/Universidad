...
# 1 "./LM75_Prototypes.h" 1
# 11 "./LM75_Prototypes.h"
void LM75_init(void);
...
void LM75_init()
{
  ...
  LM75_set(0x03,0x2380);
  LM75_set(0x02,0x1E80);
}
...
# 1 "./Lcd4_prototypes.h" 1
# 15 "./Lcd4_prototypes.h"
void LCD_init(void);
...
void LCD_string(char row, char column, char text[])
{
  LCD_command(rowAddr[row] + column);
  while(*text)
  {
    LCD_data(*text++);
  }
...
int main(int argc, char** argv)
{
  ...
  while(1)
  {
    sprintf( out,"Tempr:%3.2fC",LM75_read(0x00) );
    LCD_string(0,0,out);
