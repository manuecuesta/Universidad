...
for (let i in menu) {
    menuHTML += "<li id=" + menu[i].id + " onclick=" + menu[i].onclick + "><a href='" + menu[i].url + "'>" + menu[i].name + "</a>";
...
function ajaxcambiarnombre() {
    var nombre = $('#nombre').val();
    $.ajax({
        url: '/Proyecto_DAW/cambiarnombre',
        type: 'POST',
        data: {nombre: nombre},
...
function ajaxcambiarpass() {
    var pass = $('#pass').val();
    $.ajax({
        url: '/Proyecto_DAW/cambiarpass',
        type: 'POST',
        data: {pass: pass},
        success: function (resultText) {
            console.log('OK!!');
...
function ajaxcambiarcorreo() {
    var correo = $('#correo').val();
    $.ajax({
        url: '/Proyecto_DAW/cambiarcorreo',
        type: 'POST',
        data: {correo: correo},
        success: function (resultText) {
            console.log('OK!!');
...
function ajaxeliminar(id) {
    $.ajax({
        url: '/Proyecto_DAW/eliminararticulo',
        type: 'POST',
        data: {boton: id},
        success: function (resultText) {
            console.log('OK!!');
